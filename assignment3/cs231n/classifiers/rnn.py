...
class CaptioningRNN(object):
    ...
    def loss(self, features, captions):
        ...
        # Weight and bias for the hidden-to-vocab transformation. H * V
        ...
        if self.cell_type == 'rnn':  # x, h0, Wx, Wh, b
    ...
    def sample(self, features, max_length=30):
        ...
        for i in range(max_length):
            if self.cell_type == 'rnn':
                ...
                cur_hidden_state, cur_cell_state, _ = lstm_step_forward(word_embed, cur_hidden_state,
                                                        cur_cell_state, Wx, Wh, b)
